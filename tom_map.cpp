...
function void
tom_mapping(Mapping *mapping, i64 global_id, i64 file_id, i64 code_id){
    ...
    // Split/close panels
    Bind(close_other_panels, KeyCode_1, KeyCode_Alt);
    ...
    Bind(interactive_kill_buffer,       KeyCode_W, KeyCode_Control, KeyCode_Shift);
    Bind(kill_buffer,                   KeyCode_W, KeyCode_Control); // Browser-like
    ...
    Bind(move_left_whitespace_boundary,    KeyCode_B, KeyCode_Alt);
    Bind(move_right_whitespace_boundary,   KeyCode_F, KeyCode_Alt);
    
    // Bind(move_left_alpha_numeric_or_camel_boundary,  KeyCode_B, KeyCode_Alt);
    ...
    Bind(delete_alpha_numeric_boundary,    KeyCode_D, KeyCode_Alt);
    ...
    Bind(word_complete_drop_down,    KeyCode_Y, KeyCode_Alt);
